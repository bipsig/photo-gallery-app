//A modal is an overlay view that will pop up on our webpage when we click on a particular image to dispay us the images and its details

import { FaTimes } from 'react-icons/fa';

const Modal = ({ data, content, setSelectedContent, setShowModal }) => {

	const { name, url, description, date, type } = content;			//De-structuring the content recieved
			...
			<div style={styles.modalContent}>
				...
				<div style={styles.splitContainer}>
					<div style={styles.modalImageContainer}>
						<img style={styles.modalImage} src={url} alt="gallery-pic" />
